...
public class SecurityConfigure extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/user/verify-questions").permitAll()
                .antMatchers("/api/user/dup-check-by-userId/**").permitAll()
                .antMatchers("/api/user/dup-check-by-nickname/**").permitAll()
                .antMatchers("/api/problems/state-types").permitAll()
